...
const Home: NextPage = () => {
    ...
    try {
      ...
      if (res.status === 204 || !res.ok) {
        toast({
          ...
          description:
            "Sjekk at utdanningsinstitusjonen er riktig og husk at emnekoden kan ha blitt endret i nyere tid.",
          status: "error",
          duration: 7000,
          isClosable: true,
        });
  ...
  return (
    <>
      <Head>
        <title>
          Karakterweb - Karakterstatistikk ved norske universiteter som UiO,
          NTNU
        </title>
